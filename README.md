...
```javascript
import gsorthpBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp-by@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsorthp-by@esm/index.mjs';
```
